<template>
  <div class="public-incident" :class="{'is-open':open}">
    ...
    <div class="table-container">
      ...
      <div class="table-content">
        ...
        <el-table :data="eventList" :height="open?'84%':'70%'" size="mini">
          ...
          <el-table-column align="center" min-width="120px" :filters="eventTypeList" :filter-method="eventTypeFilter" prop="eventlist.name" label="报警类型"></el-table-column>
          <el-table-column align="center" prop="public_name" label="姓名"></el-table-column>
          <el-table-column align="center" :filters="apartmentList" :filter-method="eventTypeFilter" prop="building.code" label="位置"></el-table-column>
          <el-table-column align="center" prop="eventstatus.name" :filters="statusList" :filter-method="eventTypeFilter" label="状态"></el-table-column>
          <el-table-column align="center" min-width="120px" prop="dispose_time" label="完成时间"></el-table-column>
          <el-table-column align="center" :filters="handlerList" :filter-method="eventTypeFilter" prop="dispose_name" label="处理人"></el-table-column>
...
import {loadList,loadEventList} from '@/api/incident/public'
